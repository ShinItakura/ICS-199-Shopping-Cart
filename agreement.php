...
<body>
    ...
    <p>5.2	You acknowledge that [personal data that you submit for publication through our website or services] may be available, via the internet, around the world. We cannot prevent the use (or misuse) of such personal data by others.</p>
    ...
    <p>7.3	We [may] OR [will] notify you of [changes] OR [significant changes] to this policy [by email or through the private messaging system on our website].</p>
    <h3>8.	Your rights</h3>
    ...
    <p>8.13	You may exercise any of your rights in relation to your personal data [by written notice to us] OR [by [methods]][, in addition to the other methods specified in this Section 8].</p>
